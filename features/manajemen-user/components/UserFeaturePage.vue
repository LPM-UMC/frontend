          ...
          <table class="w-full min-w-[980px] border-separate border-spacing-0">
            <thead>
              <tr>
                ...
                <th class="border-b border-[#e3e7ee] bg-[#f1f3f6] px-4 py-3 text-left text-[1.05rem] font-semibold text-[#2f3744]">Email</th>
                <th class="border-b border-[#e3e7ee] bg-[#f1f3f6] px-4 py-3 text-left text-[1.05rem] font-semibold text-[#2f3744]">Role</th>
          ...
          <div class="mt-7 space-y-5">
            ...
            <div class="rounded-[12px] border border-[#f0a3a3] bg-[#fff3f3] px-4 py-3 text-[#c52222]">
              <p class="text-[0.98rem] leading-relaxed">
                ...
                {{ props.mode === 'create'
                  ? 'Role yang dipilih menentukan hak akses user pada modul dan data. Pastikan role yang dipilih sudah sesuai sebelum menekan tombol Buat.'
                  : 'Role yang dipilih menentukan hak akses user pada sistem. Pastikan role yang dipilih sudah sesuai sebelum menekan tombol Edit.' }}
              </p>
            </div>

            <div
              v-if="props.mode !== 'create'"
              class="rounded-[16px] border border-[#dce1e8] bg-[#f7f8fa] p-5"
            >
