            ...
            <label class="flex flex-col gap-1.5">
              ...
              <div class="relative w-full">
                <input v-model="createForm.tanggal_mulai" type="date"
                  class="h-11 w-full rounded-[10px] border border-[#d8dbe2] bg-white px-3 pr-10 text-[13px] text-[#2f3744] outline-none transition focus:border-[#e1121b] [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:right-0 [&::-webkit-calendar-picker-indicator]:h-full [&::-webkit-calendar-picker-indicator]:w-10 [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-0">
                <div class="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[#9ca3af]">
...
import { usePeriode } from '../composables/usePeriode'
