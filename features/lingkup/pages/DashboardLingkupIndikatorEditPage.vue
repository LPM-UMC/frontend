...
const pageTitle = computed(() => {
  if (true) return 'Edit Indikator Evaluasi'
...
const formTitle = computed(() => {
  if (true) return 'Form Edit Indikator Evaluasi'
...
const showQuestionField = computed(() =>
  true || form.type === 'scale'
)

const showScaleSection = computed(() => form.type === 'scale')

const showTypeField = computed(() => false)
...
watch(
  [() => 'edit', lingkupId, objekId, indikatorId],
  () => {
    setupFormByMode()
  },
  { immediate: true }
