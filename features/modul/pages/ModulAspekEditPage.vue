...
const breadcrumbItems = computed(() => [
  ...
  {
    label: form.nama || 'Detail Aspek',
    to: `/dashboard/manajemen-modul/${modulId.value}/aspek/${aspekId.value}`,
  },
  {
    label: t('manajemenAspek.editAspekJudul'),
    active: true,
  },
])
...
<template>
  ...
  <div v-else>
    ...
    <div class="mb-4 flex flex-wrap items-center gap-2">
      <NuxtLink :to="localePath(`/dashboard/manajemen-modul/${modulId}/aspek/${aspekId}`)">
        <button
