...
const moduleData = ref<DashboardModuleData>(getDashboardDummyModuleData('ami'))
const defaultCardColor = '#ffffff'
const alternateCardColor = '#f6f7f9'

onMounted(async () => {
  moduleData.value = await repository.getModuleData('ami')
})
...
<template>
  ...
  <section class="mx-auto max-w-[1440px] px-4 pb-10 pt-8 sm:px-5 md:px-6 md:pt-10">
    <div class="mx-auto mb-7 max-w-[760px]">
      <div class="relative">
        <input
          v-model="search"
          type="text"
