      ...
      <section class="relative flex items-center justify-center bg-white px-6">
        ...
        <div class="w-full max-w-105 relative">
          ...
          <form @submit.prevent="handleLogin" class="mt-8 space-y-4">
            ...
            <!-- Email -->
            <div>
              <label class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wider">{{ $t('login.email') || 'Email' }}</label>
              <div class="relative">
                <input
                  type="email"
                  v-model="form.email"
                  ...
                  class="w-full h-12 px-4 bg-gray-50 border border-gray-200 rounded-2xl text-sm text-gray-900 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200"
                />
              </div>
            ...
            <!-- Password -->
            <div>
              <label class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wider">{{ $t('login.password') || 'Password' }}</label>
              <div class="relative">
                <input
                  ...
                  maxlength="255"
                  placeholder="••••••••"
                  class="w-full h-12 px-4 pr-12 bg-gray-50 border border-gray-200 rounded-2xl text-sm text-gray-900 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200"
                />
                <button
                  type="button"
            ...
            <div class="flex items-center justify-between">
              <label class="flex items-center gap-2 cursor-pointer select-none">
                ...
                />
                <span class="text-xs font-semibold text-gray-700">{{ $t('login.rememberMe') || 'Ingat Saya' }}</span>
              </label>
            </div>
