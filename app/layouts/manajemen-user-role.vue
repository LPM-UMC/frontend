...
const modulMenus = computed<MenuItem[]>(() => [
  ...
  {
    id: 'user',
    label: $t('manajemen_user.nama'),
    to: localePath('/dashboard/manajemen-user'),
    icon: 'user',
  },
  {
    id: 'role',
    label: $t('manajemen_role.nama'),
...
<template>
  <div class="min-h-screen bg-[#e4e4e6] text-slate-900">
      ...
      <div class="mx-auto flex h-16.5 w-full max-w-550 items-center justify-between gap-2 px-3 sm:gap-3 sm:px-6">
        <div class="flex min-w-0 items-center gap-2.5">
          ...
          <NuxtLink class="flex gap-2 items-center" :to="localePath('/')">
            <div class="cursor-pointer grid h-10.5 w-10.5 place-items-center rounded-[12px] border border-[#d8dde4] bg-white shadow-[0_6px_16px_rgba(15,23,42,0.1)]">
    ...
    <main
      class="flex-1 bg-[#f4f4f4] pb-6 pt-16.5 transition-[padding-left] duration-300"
